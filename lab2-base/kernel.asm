...
80100d2d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d33:	e8 88 61 00 00       	call   80106ec0 <copyout>
...
80101fa8:	68 be 76 10 80       	push   $0x801076be
...
80102f72:	e8 19 28 00 00       	call   80105790 <idtinit>
...
80102f93:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102f96:	e8 f5 38 00 00       	call   80106890 <switchkvm>
  seginit();
80102f9b:	e8 60 38 00 00       	call   80106800 <seginit>
  lapicinit();
...
80102ff4:	e8 c7 2a 00 00       	call   80105ac0 <uartinit>
  pinit();         // process table
80102ff9:	e8 22 08 00 00       	call   80103820 <pinit>
  tvinit();        // trap vectors
80102ffe:	e8 0d 27 00 00       	call   80105710 <tvinit>
  binit();         // buffer cache
...
8010310e:	68 58 74 10 80       	push   $0x80107458
...
801031c6:	68 75 74 10 80       	push   $0x80107475
...
80103268:	ff 24 95 9c 74 10 80 	jmp    *-0x7fef8b64(,%edx,4)
8010326f:	90                   	nop
...
80103293:	68 5d 74 10 80       	push   $0x8010745d
...
8010331d:	68 7c 74 10 80       	push   $0x8010747c
...
801033c0:	00 00 00 
  initlock(&p->lock, "pipe");
801033c3:	68 b0 74 10 80       	push   $0x801074b0
...
80103774:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103777:	c7 40 14 02 57 10 80 	movl   $0x80105702,0x14(%eax)
  p->context = (struct context*)sp;
...
80103826:	68 b5 74 10 80       	push   $0x801074b5
...
80103923:	e8 a8 33 00 00       	call   80106cd0 <setupkvm>
...
80103941:	e8 6a 30 00 00       	call   801069b0 <inituvm>
...
801039af:	68 e5 74 10 80       	push   $0x801074e5
801039b4:	50                   	push   %eax
801039b5:	e8 76 0d 00 00       	call   80104730 <safestrcpy>
  p->cwd = namei("/");
801039ba:	c7 04 24 ee 74 10 80 	movl   $0x801074ee,(%esp)
...
801039f3:	68 cc 74 10 80       	push   $0x801074cc
...
80103a2b:	e8 70 2e 00 00       	call   801068a0 <switchuvm>
  return 0;
...
80103a4a:	e8 a1 30 00 00       	call   80106af0 <allocuvm>
...
80103a6a:	e8 b1 31 00 00       	call   80106c20 <deallocuvm>
...
80103ab8:	e8 e3 32 00 00       	call   80106da0 <copyuvm>
...
80103bf0:	e8 ab 2c 00 00       	call   801068a0 <switchuvm>
...
80103c02:	e8 84 0b 00 00       	call   8010478b <swtch>
      switchkvm();
80103c07:	e8 84 2c 00 00       	call   80106890 <switchkvm>
      c->proc = 0;
...
80103e1d:	68 3d 75 10 80       	push   $0x8010753d
80103e22:	e8 69 c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103e27:	83 ec 0c             	sub    $0xc,%esp
80103e2a:	68 30 75 10 80       	push   $0x80107530
...
80103f39:	68 4f 75 10 80       	push   $0x8010754f
80103f3e:	e8 4d c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103f43:	83 ec 0c             	sub    $0xc,%esp
80103f46:	68 49 75 10 80       	push   $0x80107549
...
80103fe2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103fe9:	e8 62 2c 00 00       	call   80106c50 <freevm>
        release(&ptable.lock);
...
8010413b:	68 d7 78 10 80       	push   $0x801078d7
...
8010415c:	74 ea                	je     80104148 <procdump+0x28>
      state = "???";
8010415e:	ba 60 75 10 80       	mov    $0x80107560,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104163:	83 f8 05             	cmp    $0x5,%eax
80104166:	77 11                	ja     80104179 <procdump+0x59>
80104168:	8b 14 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%edx
      state = "???";
8010416f:	b8 60 75 10 80       	mov    $0x80107560,%eax
...
8010417e:	68 64 75 10 80       	push   $0x80107564
...
801041bd:	68 a1 6f 10 80       	push   $0x80106fa1
...
801041ea:	68 d8 75 10 80       	push   $0x801075d8
...
8010449b:	68 e3 75 10 80       	push   $0x801075e3
...
801044f5:	68 eb 75 10 80       	push   $0x801075eb
801044fa:	e8 91 be ff ff       	call   80100390 <panic>
    panic("popcli");
801044ff:	83 ec 0c             	sub    $0xc,%esp
80104502:	68 02 76 10 80       	push   $0x80107602
...
80104521:	68 09 76 10 80       	push   $0x80107609
...
801057f0:	e8 eb e0 ff ff       	call   801038e0 <myproc>
...
80105810:	e8 ab e0 ff ff       	call   801038c0 <cpuid>
...
80105821:	e8 ba e0 ff ff       	call   801038e0 <myproc>
80105826:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105829:	e8 b2 e0 ff ff       	call   801038e0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105852:	e8 89 e0 ff ff       	call   801038e0 <myproc>
...
8010585e:	e8 7d e0 ff ff       	call   801038e0 <myproc>
80105863:	85 c0                	test   %eax,%eax
80105865:	74 1d                	je     80105884 <trap+0xc4>
80105867:	e8 74 e0 ff ff       	call   801038e0 <myproc>
...
80105884:	e8 57 e0 ff ff       	call   801038e0 <myproc>
80105889:	85 c0                	test   %eax,%eax
8010588b:	74 0b                	je     80105898 <trap+0xd8>
8010588d:	e8 4e e0 ff ff       	call   801038e0 <myproc>
...
80105896:	74 38                	je     801058d0 <trap+0x110>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105898:	e8 43 e0 ff ff       	call   801038e0 <myproc>
8010589d:	85 c0                	test   %eax,%eax
8010589f:	74 1d                	je     801058be <trap+0xfe>
801058a1:	e8 3a e0 ff ff       	call   801038e0 <myproc>
...
801058d4:	75 c2                	jne    80105898 <trap+0xd8>
    yield();
801058d6:	e8 65 e5 ff ff       	call   80103e40 <yield>
...
801058e7:	0f 84 eb 00 00 00    	je     801059d8 <trap+0x218>
    lapiceoi();
801058ed:	e8 5e cf ff ff       	call   80102850 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058f2:	e8 e9 df ff ff       	call   801038e0 <myproc>
...
80105901:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105908:	e8 03 ce ff ff       	call   80102710 <kbdintr>
    lapiceoi();
8010590d:	e8 3e cf ff ff       	call   80102850 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105912:	e8 c9 df ff ff       	call   801038e0 <myproc>
...
8010594f:	e8 6c df ff ff       	call   801038c0 <cpuid>
...
8010595c:	e8 4f ad ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105961:	e8 ea ce ff ff       	call   80102850 <lapiceoi>
    break;
80105966:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105969:	e8 72 df ff ff       	call   801038e0 <myproc>
...
801059bf:	5d                   	pop    %ebp
      exit();
801059c0:	e9 4b e3 ff ff       	jmp    80103d10 <exit>
801059c5:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
801059c8:	e8 43 e3 ff ff       	call   80103d10 <exit>
...
80105a0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      exit();
80105a10:	e8 fb e2 ff ff       	call   80103d10 <exit>
80105a15:	eb 85                	jmp    8010599c <trap+0x1dc>
80105a17:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105a1a:	e8 a1 de ff ff       	call   801038c0 <cpuid>
...
80105a95:	e8 d6 cd ff ff       	call   80102870 <microdelay>
...
80105b3d:	e8 6e c8 ff ff       	call   801023b0 <ioapicenable>
...
80106684:	e8 27 bf ff ff       	call   801025b0 <kalloc>
...
801067b3:	e8 38 bc ff ff       	call   801023f0 <kfree>
      *pte = 0;
...
80106803:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106806:	e8 b5 d0 ff ff       	call   801038c0 <cpuid>
  pd[0] = size-1;
...
801068c4:	0f 84 c2 00 00 00    	je     8010698c <switchuvm+0xec>
  pushcli();
801068ca:	e8 d1 da ff ff       	call   801043a0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801068cf:	e8 6c cf ff ff       	call   80103840 <mycpu>
801068d4:	89 c6                	mov    %eax,%esi
801068d6:	e8 65 cf ff ff       	call   80103840 <mycpu>
801068db:	89 c7                	mov    %eax,%edi
801068dd:	e8 5e cf ff ff       	call   80103840 <mycpu>
801068e2:	83 c7 08             	add    $0x8,%edi
801068e5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801068e8:	e8 53 cf ff ff       	call   80103840 <mycpu>
...
80106931:	e8 0a cf ff ff       	call   80103840 <mycpu>
...
8010694f:	e8 ec ce ff ff       	call   80103840 <mycpu>
80106954:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106957:	e8 e4 ce ff ff       	call   80103840 <mycpu>
...
80106979:	5d                   	pop    %ebp
  popcli();
8010697a:	e9 31 db ff ff       	jmp    801044b0 <popcli>
...
801069cb:	77 49                	ja     80106a16 <inituvm+0x66>
  mem = kalloc();
801069cd:	e8 de bb ff ff       	call   801025b0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106aa6:	e8 55 af ff ff       	call   80101a00 <readi>
...
80106b69:	0f 86 a1 00 00 00    	jbe    80106c10 <allocuvm+0x120>
    mem = kalloc();
80106b6f:	e8 3c ba ff ff       	call   801025b0 <kalloc>
...
80106bfb:	e8 f0 b7 ff ff       	call   801023f0 <kfree>
      return 0;
...
80106c9e:	e8 4d b7 ff ff       	call   801023f0 <kfree>
...
80106cb3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106cb4:	e9 37 b7 ff ff       	jmp    801023f0 <kfree>
    panic("freevm: no pgdir");
...
80106cd5:	e8 d6 b8 ff ff       	call   801025b0 <kalloc>
...
80106de3:	e8 18 d8 ff ff       	call   80104600 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106de8:	58                   	pop    %eax
80106de9:	5a                   	pop    %edx
80106dea:	53                   	push   %ebx
80106deb:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106dee:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106df1:	b9 00 10 00 00       	mov    $0x1000,%ecx
...
80106e35:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106e3b:	e8 70 b7 ff ff       	call   801025b0 <kalloc>
...
80106e4a:	e8 01 fe ff ff       	call   80106c50 <freevm>
  return 0;
80106e4f:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
80106e67:	68 f4 78 10 80       	push   $0x801078f4
80106e6c:	e8 1f 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: page not present");
80106e71:	83 ec 0c             	sub    $0xc,%esp
80106e74:	68 0e 79 10 80       	push   $0x8010790e
80106e79:	e8 12 95 ff ff       	call   80100390 <panic>
...
80106ec9:	8b 75 14             	mov    0x14(%ebp),%esi
80106ecc:	8b 55 0c             	mov    0xc(%ebp),%edx
  ...
  buf = (char*)p;
  while(len > 0){
80106ecf:	85 f6                	test   %esi,%esi
80106ed1:	75 38                	jne    80106f0b <copyout+0x4b>
80106ed3:	eb 6b                	jmp    80106f40 <copyout+0x80>
...
80106edb:	89 fb                	mov    %edi,%ebx
80106edd:	29 d3                	sub    %edx,%ebx
80106edf:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
80106ee5:	39 f3                	cmp    %esi,%ebx
80106ee7:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80106eea:	29 fa                	sub    %edi,%edx
80106eec:	83 ec 04             	sub    $0x4,%esp
80106eef:	01 c2                	add    %eax,%edx
80106ef1:	53                   	push   %ebx
80106ef2:	ff 75 10             	pushl  0x10(%ebp)
80106ef5:	52                   	push   %edx
80106ef6:	e8 05 d7 ff ff       	call   80104600 <memmove>
    len -= n;
    buf += n;
80106efb:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
80106efe:	8d 97 00 10 00 00    	lea    0x1000(%edi),%edx
  while(len > 0){
80106f04:	83 c4 10             	add    $0x10,%esp
80106f07:	29 de                	sub    %ebx,%esi
80106f09:	74 35                	je     80106f40 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
80106f0b:	89 d7                	mov    %edx,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80106f0d:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
80106f10:	89 55 0c             	mov    %edx,0xc(%ebp)
80106f13:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80106f19:	57                   	push   %edi
80106f1a:	ff 75 08             	pushl  0x8(%ebp)
80106f1d:	e8 5e ff ff ff       	call   80106e80 <uva2ka>
    if(pa0 == 0)
80106f22:	83 c4 10             	add    $0x10,%esp
80106f25:	85 c0                	test   %eax,%eax
80106f27:	75 af                	jne    80106ed8 <copyout+0x18>
  }
  return 0;
}
80106f29:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
